...
\toprule
\textbf{Tramo} & \textbf{Recirc.} & \textbf{n viv} & \textbf{Coef. simult.} & \textbf{Caudal (l/s)} & \textbf{Caudal (l/h)} & \textbf{DN (mm)} & \textbf{Di (mm)} & \textbf{Velocidad (m/s)} & \textbf{Espesor aisl. (mm)} & \textbf{Pérdidas (W/m)} & \textbf{L recto (m)} & \textbf{Pérdidas (W)} \\
\midrule
