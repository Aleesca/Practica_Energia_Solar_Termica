...
\begin{enumerate}
    \item \uline{CTE DB-HE4 (Código Técnico de la Edificación - Ahorro de Energía):} Define la contribución mínima de energía renovable para la producción de ACS en el edificio residencial.
    \item \uline{RITE (Reglamento de Instalaciones Térmicas en los Edificios - R.D. 1027/2007):} Establece las exigencias de eficiencia energética, seguridad y mantenimiento para la red térmica centralizada.
    \item \uline{Real Decreto 487/2022:} Regula las medidas sanitarias y los requisitos de inspección y limpieza periódica física de los depósitos acumuladores de ACS para la prevención y el control de la legionelosis.
    \item \uline{Real Decreto 919/2006:} Reglamento técnico de distribución y utilización de combustibles gaseosos, aplicable a la instalación del quemador de la caldera auxiliar centralizada de gas natural.
    \item \uline{Norma UNE 60670:} Gobierna el diseño, ventilación, seguridad y configuración de la sala de calderas para el sistema auxiliar de gas natural en Media Presión A.
\end{enumerate}
...
\includepdf[pages=-, pagecommand={\thispagestyle{empty}}, fitpaper=true]{Figuras/Planos/emplazamiento-situacion.pdf}
\includepdf[pages=-, pagecommand={\thispagestyle{empty}}, fitpaper=true]{Figuras/Planos/plano_azotea.pdf}
